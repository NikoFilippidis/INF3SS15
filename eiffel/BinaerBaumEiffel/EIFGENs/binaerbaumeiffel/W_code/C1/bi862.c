...
#define ui4_1 ui4_1x.it_i4
	...
	if ((EIF_BOOLEAN)(tr1 != NULL)) {
		...
		RTDBGAA(Current, dtype, 4910, 0xF800035C, 0); /* root */
		RTAR(Current, loc1);
		*(EIF_REFERENCE *)(Current + RTWA(4910, dtype)) = (EIF_REFERENCE) RTCCL(loc1);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 861, Current, 1, 2, 12665);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (arg1) {
		RTCC(arg1, 861, l_feature_name, 1, eif_new_type(860, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	if ((EIF_BOOLEAN)(arg1 != NULL)) {
		...
		if ((EIF_BOOLEAN) (arg2 <= ti4_1)) {
			RTHOOK(3);
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4906, "getleft", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			if ((EIF_BOOLEAN)(tr1 == NULL)) {
				RTHOOK(4);
				RTDBGAL(Current, 1, 0xF800035C, 0, 0); /* loc1 */
				tr1 = RTLN(eif_new_type(860, 0x01).id);
				...
				RTHOOK(5);
				ur1 = RTCCL(loc1);
				(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4903, "setleft", arg1))(arg1, ur1x);
				RTHOOK(6);
				ur1 = RTCCL(arg1);
				(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4905, "setparent", loc1))(loc1, ur1x);
			} else {
				RTHOOK(7);
				tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4906, "getleft", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
				ur1 = RTCCL(tr1);
		...
		if ((EIF_BOOLEAN) (arg2 >= ti4_1)) {
			RTHOOK(9);
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4907, "getright", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			if ((EIF_BOOLEAN)(tr1 == NULL)) {
				RTHOOK(10);
				RTDBGAL(Current, 1, 0xF800035C, 0, 0); /* loc1 */
				tr1 = RTLN(eif_new_type(860, 0x01).id);
				...
				RTHOOK(11);
				ur1 = RTCCL(loc1);
				(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4904, "setright", arg1))(arg1, ur1x);
				RTHOOK(12);
				ur1 = RTCCL(arg1);
				(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4905, "setparent", loc1))(loc1, ur1x);
			} else {
...
#define ur1 ur1x.it_r
	...
	if ((EIF_BOOLEAN)(tr1 != NULL)) {
		...
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(4910, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr1);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(4916, dtype))(Current, ur1x);
	}
	RTHOOK(3);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 861, Current, 1, 2, 12669);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (arg2) {
		RTCC(arg2, 861, l_feature_name, 2, eif_new_type(860, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(arg2 != NULL)) {
		...
		if ((EIF_BOOLEAN)(arg1 == ti4_1)) {
			RTHOOK(4);
			if ((EIF_BOOLEAN)(loc1 == (EIF_BOOLEAN) 0)) {
				RTHOOK(5);
				ur1 = RTLN(eif_new_type(206, 0x00).id);
				*(EIF_INTEGER_32 *)ur1 = arg1;
				(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(30, dtype))(Current, ur1x);
				RTHOOK(6);
				tr1 = RTMS_EX_H(" Found",6,1933419108);
				ur1 = tr1;
				(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(30, dtype))(Current, ur1x);
				RTHOOK(7);
		...
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4909, "getvalue", arg2))(arg2)).it_i4);
		if ((EIF_BOOLEAN) (arg1 > ti4_1)) {
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4907, "getright", arg2))(arg2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		...
		if (tb1) {
			...
			ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4909, "getvalue", arg2))(arg2)).it_i4);
			if ((EIF_BOOLEAN) (arg1 < ti4_1)) {
				tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4906, "getleft", arg2))(arg2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
				tb1 = (EIF_BOOLEAN)(tr1 != NULL);
			}
			if (tb1) {
				RTHOOK(12);
				...
				if ((EIF_BOOLEAN)(loc1 == (EIF_BOOLEAN) 0)) {
					...
					RTNHOOK(14,1);
					ui4_1 = arg1;
					(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(160, "putint", tr1))(tr1, ui4_1x);
					RTHOOK(15);
					tr1 = RTMS_EX_H(" Not Found",10,520802148);
					ur1 = tr1;
					(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(30, dtype))(Current, ur1x);
					RTHOOK(16);
					tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(27, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
